            ...
            .map((s) => (
              <li key={s.full_name}>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-baseline gap-3 rounded-md border border-zinc-800/60 hover:border-emerald-700/50 bg-zinc-950/40 px-4 py-2.5 transition-colors group"
                >
