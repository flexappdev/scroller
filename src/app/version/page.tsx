...
const RELEASES: Release[] = [
  {
    ...
    bullets: [
      "Sticky app header exposes every media, knowledge, source, S3 and Mediai destination without a permanent sidebar",
      ...
      "Priority publish menu links Gorai, Siems Production, WIKAI and Mediai",
      "Mediai detail sheet adds Wikipedia context, inline motion and narration, article actions and restorable card deep links",
  ...
  },
  {
    ...
    date: "2026-08-29",
    commit: "922b0d6",
    headline: "Mediai-first Scroller homepage",
    bullets: [
      "Generated Mediai assets became the default full-screen snap feed",
      "All asset stores and publishing destinations were consolidated into sticky app chrome",
      "Random feed shuffling preserves order while later Mediai pages append",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Vercel Analytics removed 2026-09-03 to cut Observability event cost",
