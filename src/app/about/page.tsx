  ...
  return (
    <div className="px-6 py-12 max-w-3xl mx-auto space-y-10">
      ...
      <section className="space-y-4">
        ...
        <Link
          href="/diagrams"
          className="flex items-center justify-between gap-3 rounded-lg border border-zinc-800 bg-zinc-900/50 px-4 py-3 hover:border-emerald-700/50 group transition-colors"
        >
          <div>
            ...
            <div className="text-xs text-zinc-500 mt-0.5">
              8 editorial tech sheets — stack, architecture, cache flow, source fetchers, image
              resolver, mobile card anatomy, auth gate, content pipeline.
            </div>
          </div>
          <ExternalLink className="h-4 w-4 text-zinc-500 group-hover:text-emerald-400" />
        </Link>
      </section>
