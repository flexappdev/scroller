  ...
  return (
    <div className="px-6 py-12 max-w-3xl mx-auto space-y-10">
      ...
      <section className="space-y-4">
        ...
        <h3 className="text-xs uppercase tracking-wider text-zinc-600 font-mono pt-2">Content generation pipeline</h3>
        <p className="text-sm text-zinc-400">
          Every image, video, and diagram that ships with Scroller is generated by an
          ABC skill or one of the in-repo scripts and uploaded to{" "}
          <code className="text-emerald-400 text-xs">s3://com27/scroller/</code> —
          idempotent, re-runnable, and version-pinned to Runware FLUX (images) +
          Seedance (video).
        </p>
        <div className="rounded-lg border border-zinc-800 bg-zinc-950 overflow-hidden">
          <iframe
            src="/diagrams/content-pipeline.html"
            title="Scroller content generation pipeline diagram"
            className="w-full border-0"
            style={{ height: 520 }}
            loading="lazy"
          />
        ...
        <p className="text-xs text-zinc-600">
          Accent lines = AI-generated assets · full screen:{" "}
          <a href="/diagrams/content-pipeline.html" className="underline hover:text-zinc-400" target="_blank" rel="noreferrer">open diagram</a>
        </p>
      </section>
