...
- 📋 Generate ambient video loops for `/about` + per-source hero panels: `node scripts/generate-video-loops-runware.mjs` (10 Seedance clips, ~50s @ 720p, uploads to `s3://com27/scroller/video-loops/`).
